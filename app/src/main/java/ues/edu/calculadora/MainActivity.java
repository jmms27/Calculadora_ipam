...
public class MainActivity extends AppCompatActivity {
    ...
    public void limpiar(View v) {//los borrados

        switch (v.getId()) {
            case R.id.ibtnBorrar://1 en 1
                if(!texto.equals("")){
                ...
                break;
            case R.id.btnC: //borra numero de pantalla
                texto = "";
                numero = 0;
                Sipunto=false;
                break;
            case R.id.btnCE: //borrado completo de la pantalla
                texto = "";
                texto2 = "";
                numero = 0;
                NumA = 0;
    ...
    //El metodo operaciones realiza cada una de las operaciones
